...
Each of the `AmusixBackapp/`, `AmusixFrontapp/` and `tests/` directories contain a `README.adoc` file at their root with step-by-step guides on how to properly set up and launch everything you need.